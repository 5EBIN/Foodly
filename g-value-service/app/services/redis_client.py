...
class RedisService:
    ...
    @staticmethod
    def get_orders_cache_key(worker_id: str) -> str:
        """Get the cache key for orders."""
        return f"orders:{worker_id}"
    
    @staticmethod
    def get_earnings_cache_key(worker_id: str) -> str:
        """Get the cache key for earnings."""
        return f"earnings:{worker_id}"